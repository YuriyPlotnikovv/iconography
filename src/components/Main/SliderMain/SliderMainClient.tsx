...
export default function SliderMainClient({ slidesList }: SliderMainClientProps): JSX.Element {
  ...
  return (
    <section className={clsx('section', sliderStyles['slider'], stylesSliderMain['slider-main'])}>
      <h2 className="visually-hidden">Новости и акции</h2>
      ...
      >
        {slidesList.map((slide, index) => {
          return (
            ...
            >
              <Image
                className={stylesSliderMain['slider-main__item-image']}
                src={slide.image}
                alt={slide.alt}
                fill
                sizes="100vw"
              ...
              <div className={stylesSliderMain['slider-main__item-content']}>
                <h3 className={stylesSliderMain['slider-main__item-title']}>{slide.title}</h3>

                <div
                  className={clsx('block-html', stylesSliderMain['slider-main__item-text'])}
                  dangerouslySetInnerHTML={createSanitizedHTML(slide.description)}
                />

                <Link
                  className={clsx(
                    stylesSliderMain['slider-main__item-button'],
                    'button',
                    'button--arrow',
                  )}
        ...
        <div
          ...
          className={clsx(
            ...
            stylesSliderMain['slider-main__pagination'],
          )}
        ></div>
        ...
        <button
          ...
          className={clsx(
            ...
            stylesSliderMain['slider-main__navigation-item'],
            stylesSliderMain['slider-main__navigation-item--prev'],
          )}
        ...
        <button
          ...
          className={clsx(
            sliderStyles['slider__navigation-item'],
            stylesSliderMain['slider-main__navigation-item'],
            stylesSliderMain['slider-main__navigation-item--next'],
          )}
