...
export default function FormCalculation(): JSX.Element {
    return (
        <form className={clsx(formStyles['form'], formStyles['form--calculation'])} action="#">
            <label className={formStyles['form__label']}>
                <span className="visually-hidden">Ваше имя:</span>

                <input className={formStyles['form__input']} type="text" name="name" autoComplete="on"
            ...
            <label className={formStyles['form__label']}>
                ...
                <input className={formStyles['form__input']} type="tel" name="phone" autoComplete="on"
                       placeholder="Телефон"
            ...
            <label className={formStyles['form__label']}>
                ...
                <input className={formStyles['form__input']} type="email" name="email" autoComplete="on"
            ...
            <label className={formStyles['form__label']}>
                ...
                <textarea className={formStyles['form__input']} name="message" rows={5} minLength={100}
                          placeholder="Ваше сообщение" autoComplete="off"></textarea>
            </label>

            <label className={clsx(formStyles['form__label'], formStyles['form__label--checkbox'])}>
                        <span className={formStyles['form__label-text']}>
                            <a className={formStyles['form__label-link']} href="#">Я согласен</a> на обработку персональных данных в соответствии с условиями <a
                            className={formStyles['form__label-link']} href="#">Политикой обработки данных</a>
                        </span>
